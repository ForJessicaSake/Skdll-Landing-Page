...
<footer className='pl-24 pr-24 xxs:pl-8 xxs:pr-8 xxm:pl-8 xxm:pr-8 xms:pl-8 xms:pr-8'>
  <h1 className='text-lg xxs:text-sm xms:text-base font-medium mt-6 xxs:w-56 xxm:w-64 xxm:text-base smm:text-base'>Stay in the loop, subscribe to our news letter</h1>
  <form className='mt-2'>  
  ...
  <nav >
  <h1 className='font-semibold text-base'><img src={logo} alt="Skdl logo" className='w-14 mb-6'/></h1>
    <ul className=' text-sm flex w-36 justify-between'>
   <img src={twitter} alt ='twitter' className='border-2 rounded-full p-1 bg-grey w-6 h-6'/>
   <img src={icon3} alt ='twitter' className='border-2 rounded-full p-1  bg-grey w-6 h-6'/>
   <img src={icon4} alt ='instagram' className='border-2 rounded-full p-1 bg-grey w-6 h-6'/>
   <img src={icon5} alt ='facebook' className='border-2 rounded-full p-1 bg-grey w-6 h-6'/>
   <img src={icon6} alt ='linkedin' className='border-2 rounded-full p-1 bg-grey w-6 h-6 '/>
