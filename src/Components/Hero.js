  ...
  return (
    <header className="flex justify-between xms:pl-20 xms:pr-20 xxs:pl-10 xxs:pr-10 pl-28 pr-28 pt-8 xxs:justify-center xxs:flex-col xxm:flex-col  xxm:pl-8 xxm:pr-8 xms:flex-col smm:pl-20 smm:pr-20">
      <section className=" flex flex-col justify-center z-50">
        ...
        <p className="mt-6 text-lg w-96 mb-10 xms:text-sm xms:w-72 xxs:text-xs xxs:w-64 xxm:w-64 xxm:text-sm">
          Plan and schedule your day to day tasks and activities easily.
        </p>
      ...
      <section>
        <img
          src={phone}
          alt="phone"
          className="w-96 xxs:ml-2 xxs:w-wt xxs:mt-4 xms:w-80 xms:ml-2"
        />
      </section>
    </header>
  );
